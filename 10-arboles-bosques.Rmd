...
Observación: esta medida es proporcional a la pérdida logarítmica, que es el objetivo de
optimización en regresión logística (en dos o más clases), pues cuenta una penalización
de $-\log p_j(t)$ para los casos de la clase $j$. En el caso de los árboles, minimizamos
esta pérdida al intentar hacer cada corte individual.
...
### Reglas de partición y tamaño del árbol {-}
...
library(rfinterval)
casas <- read_csv("./datos/houseprices/house-prices-train.csv")
set.seed(934)
