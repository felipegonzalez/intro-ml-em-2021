...
datos_entrena <- simular_ejemplo(50)
...
ejemplo_split[[1]] <- make_splits(list("analysis" = 1:50, "assessment" = 51:2050), datos)
...
ejemplo_split <- list()
# creamos un objeto con datos de entrenamiento y de prueba
ejemplo_split[[1]] <- make_splits(list("analysis" = 1:50, "assessment" = 1:50), datos_entrena)
