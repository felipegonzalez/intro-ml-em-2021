...
modelamos de forma probabilística mediante la distribución de $\epsilon|x$.

Ahora supongamos que nosotros ajustamos un modelo $\hat{f} = f_{\mathcal L}$,
de modo que la predicción para las entradas $x$ es $\hat{y} = \hat{f}(x)$ usando
...
En estadística y machine learning, sesgo y varianza están en constante tensión. Nuestros
intentos por mejorar la varianza generalmente se pagan en sesgo y viceversa. Esto lo podemos
